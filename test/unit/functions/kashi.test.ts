  ...
  const pair = {
    asset: {
      ...
      list: {
        ...
        tags: {},
        logoURI: 'https://raw.githubusercontent.com/amblade/pa/master/sushi/logo-256x256.png',
      ...
      tokenInfo: {
        ...
        symbol: 'USDT',
        decimals: 6,
        logoURI: 'https://raw.githubusercontent.com/amblade/patswap-icons/master/token/usdt.jpg',
      },
