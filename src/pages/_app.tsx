  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">PatSwap</title>

        <meta
          key="description"
          name="description"
          content="Be a DeFi Chef with Riko. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />

        <meta name="application-name" content="PatSwap App" />
        ...
        <meta key="twitter:title" name="twitter:title" content="PatSwap App" />
        ...
        <meta key="og:site_name" property="og:site_name" content="PatSwap App" />
