    ...
    <Container id="farm-page" className="grid h-full grid-cols-4 py-4 mx-auto md:py-8 lg:py-12 gap-9" maxWidth="7xl">
      ...
      <div className={classNames('space-y-6 col-span-4 lg:col-span-3')}>
        <Search
          ...
          inputProps={{
            className:
              'relative w-full bg-transparent border border-transparent focus:border-green-900 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5',
          }}
        />
