...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@amblade/patswap-sdk'
          ...
          <div>
            ...
            <AutoColumn gap="md">
              ...
              <div>
                ...
                <AutoColumn justify="space-between" className="py-2.5 justify-center">
