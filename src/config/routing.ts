...
import { ChainId, Currency, Token, WNATIVE } from '@amblade/patswap-sdk'
...
export const COMMON_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MAINNET], DAI, USDC, USDT, WBTC, RIKO[ChainId.MAINNET]],
  [ChainId.MATIC]: [
...
export const PINNED_PAIRS: {
  ...
  [ChainId.MAINNET]: [
    [RIKO[ChainId.MAINNET], WNATIVE[ChainId.MAINNET]],
    [
