import { ChainId, Ether, SUSHI_ADDRESS, Token, WETH9, WNATIVE, RIKO_ADDRESS, RIKOBAR_ADDRESS } from '@amblade/patswap-sdk'
...
export const SUSHI: ChainTokenMap = {
  ...
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, SUSHI_ADDRESS[ChainId.AVALANCHE], 18, 'SUSHI', 'RISushiTokenKO'),
...
export const RIKO: ChainTokenMap = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, RIKO_ADDRESS[ChainId.MAINNET], 18, 'RKO', 'RIKO'),
  [ChainId.BSC]: new Token(ChainId.BSC, RIKO_ADDRESS[ChainId.BSC], 18, 'RKO', 'RIKO'),
}

export const XRIKO: ChainTokenMap = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, RIKOBAR_ADDRESS[ChainId.MAINNET], 18, 'RKO', 'RIKO'),
  [ChainId.BSC]: new Token(ChainId.BSC, RIKOBAR_ADDRESS[ChainId.BSC], 18, 'RKO', 'RIKO'),
}
