        ...
        {[
          ...
          if (chainId === key) {
            return (
              <button key={i} className="w-full col-span-1 p-px rounded">
                <div className="flex items-center w-full h-full p-3 space-x-3 rounded bg-dark-800">
                  <Image
          ...
          return (
            <button
              ...
              className="flex items-center w-full col-span-1 p-3 space-x-3 rounded cursor-pointer bg-dark-900 hover:bg-dark-700"
            >
