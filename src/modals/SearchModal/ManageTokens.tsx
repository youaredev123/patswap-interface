...
import { Token } from '@amblade/patswap-sdk'
    ...
    <div className="relative flex-1 w-full h-full mt-4 space-y-4 overflow-y-hidden">
      <div className="space-y-3">
        <input
          ...
          type="text"
          placeholder={'0x0000'}
          className="w-full bg-dark-900 border border-dark-800 focus:border-transparent focus:border-green-900 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5 appearance-none"
          value={searchQuery}
          autoComplete="off"
