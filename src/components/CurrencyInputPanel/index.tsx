import { Currency, CurrencyAmount, Pair, Percent, Token } from '@amblade/patswap-sdk'
  ...
  return (
    <div id={id} className={classNames(hideInput ? 'p-4' : 'p-5', 'rounded bg-dark-800')}>
      <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
        {!hideInput && (
          <div
            className={classNames(
              'flex items-center w-full space-x-3 rounded bg-dark-800 focus:bg-dark-700'
        ...
        <div className={classNames('pl-3 text-right')}>
          <button
            type="button"
            className={classNames(
