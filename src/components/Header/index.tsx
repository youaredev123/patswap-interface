import { ChainId, Currency, NATIVE, RIKOBAR_ADDRESS, RIKO_ADDRESS } from '@amblade/patswap-sdk'
            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logowithouttext-small.png" alt="Patswap" width="32px" height="32px" />
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    {chainId && [ChainId.MAINNET].includes(chainId) && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add xRIKO to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                const params: any = {
                                  type: 'ERC20',
                                  options: {
                                    address: RIKOBAR_ADDRESS[chainId],
                                    name: 'RIKOBAR',
                                    symbol: 'xRKO',
                                    decimals: 18,
                                    image:
                                ...
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added XRIKO to MetaMask')
                                    } else {
                          ...
                          >
                            <Image
                              src="/images/govtokens/fullriko.png"
                              alt="xRIKO"
                              width="65px"
                              height="38px"
                              objectFit="contain"
                    ...
                    {chainId && chainId in RIKO_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add RIKO to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              ...
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added RIKO to MetaMask')
                                    } else {
                                      throw new Error('Something went wrong.')
                                    }
                                  })
