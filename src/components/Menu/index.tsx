...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of PatSwap.`),
    href: 'https://docs.patswap.com',
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of PatSwap.`),
    href: 'https://dev.patswap.com',
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`PatSwap is a supporter of Open Source.`),
    href: 'https://github.com/amblade',
  },
  {
    name: i18n._(t`Tools`),
