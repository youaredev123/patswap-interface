        ...
        <div className="flex flex-col justify-between p-5 space-y-3 sm:space-y-0 sm:flex-row">
          <div className="flex items-center w-full sm:w-2/5">
            <div className="flex items-center gap-4">
              <Image
                src={
                  currency === RIKO[ChainId.MAINNET]
                    ? '/images/govtokens/rko.jpg'
                    : currency === XRIKO[ChainId.MAINNET]
                    ? '/images/tokens/xrko.jpg'
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === RIKO[ChainId.MAINNET] || currency === XRIKO[ChainId.MAINNET]) && (
                  <Typography
                    variant="xs"
                    className="underline cursor-pointer text-blue"
                    onClick={() => setCurrency(currency === XRIKO[ChainId.MAINNET] ? RIKO[ChainId.MAINNET] : XRIKO[ChainId.MAINNET], field)}
                  >
                    {currencies[field] === RIKO[ChainId.MAINNET] ? i18n._(t`Use xRIKO`) : i18n._(t`Use RIKO`)}
                  </Typography>
                )}
              </div>
            </div>
